...
public class TestSoldat {
    public static void main(String[] args) {
        Carte c = new Carte();
        Heros humain = new Heros(c, TypesH.BARBARE, "Bernard", new Position(19, 7), Color.BLACK); 
        Heros nain = new Heros(c, TypesH.CHEVALIER, "Blblbl", new Position(18, 5), Color.BLACK);
        Heros hobbit = new Heros(c, TypesH.GNOME, "Frodon", new Position(20, 7), Color.BLACK);  
